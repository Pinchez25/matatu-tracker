...
public class KafkaStreamsConfig {
    ...
    public KafkaStreamsConfiguration kafkaStreamsConfiguration(){
        return new KafkaStreamsConfiguration(Map.of(
                ...
                StreamsConfig.BOOTSTRAP_SERVERS_CONFIG, properties.getKafka().getBootstrapServers(),
                StreamsConfig.DEFAULT_KEY_SERDE_CLASS_CONFIG, Serdes.StringSerde.class,
                StreamsConfig.DEFAULT_VALUE_SERDE_CLASS_CONFIG, JacksonJsonSerde.class,
                StreamsConfig.COMMIT_INTERVAL_MS_CONFIG, 1000L,
